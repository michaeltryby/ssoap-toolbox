object frmExportMaxMinAvg: TfrmExportMaxMinAvg
  Left = 320
  Top = 160
  BorderStyle = bsDialog
  Caption = 'Export Max, Min, Avg Flows to a File'
  ClientHeight = 430
  ClientWidth = 350
  Color = clBtnFace
  ...
  object Label4: TLabel
    ...
    Width = 198
    Height = 13
    Caption = 'Maximum Flow Averaging Duration (hours)'
  end
  object Label5: TLabel
    ...
    Width = 195
    Height = 13
    Caption = 'Minimum Flow Averaging Duration (hours)'
  end
  ...
  object WriteZeroMaximumsCheckBox: TCheckBox
    Left = 7
    Top = 218
    Width = 177
    Height = 17
    Caption = 'Write Days with Zero Maximums'
    Checked = True
    State = cbChecked
    TabOrder = 6
  end
  object WriteZeroMinimumsCheckBox: TCheckBox
    Left = 7
    Top = 239
    Width = 177
    Height = 17
    Caption = 'Write Days with Zero Minimums'
    Checked = True
    State = cbChecked
    TabOrder = 7
  end
  object WriteZeroAveragesCheckBox: TCheckBox
    Left = 7
    Top = 260
    Width = 177
    Height = 17
    Caption = 'Write Days with Zero Averages'
    Checked = True
    State = cbChecked
    TabOrder = 8
  end
  object MaximumFlowAveragingDurationSpinEdit: TSpinEdit
    Left = 216
    Top = 166
    Width = 129
    Height = 22
  ...
  object MinimumFlowAveragingDurationSpinEdit: TSpinEdit
    Left = 216
    Top = 192
    Width = 129
    Height = 22
